            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <a href="#" class="navbar-brand p-0">
                    <h1 class="display-6 text-primary">
                        <img src="<?= base_url('assets/home/img/logo_desa.jpg'); ?>" style="width: 75px; height: 75px;" alt="Icon">
                        Jumsan Tenik
                    </h1>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <?php if ($this->session->userdata('status') == 'login') : ?>
                            <a href="#booking" class="nav-item nav-link">Reservasi</a>
                        <?php endif; ?>
                        <a href="#kataMereka" class="nav-item nav-link">Kata Mereka</a>
                        <a href="#kontakKami" class="nav-item nav-link">Feedback</a>
                    </div>
                    <?php if ($this->session->userdata('status') == 'login') : ?>
