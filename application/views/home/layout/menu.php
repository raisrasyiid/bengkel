<!-- Carousel Start -->
        ...
        <div class="container-fluid categories pb-5" id="vehicle">
            <div class="container pb-5">
                ...
                <div class="categories-carousel owl-carousel wow fadeInUp" data-wow-delay="0.1s">
                    <div class="categories-item p-4">
                        <div class="categories-item-inner">
                            <div class="categories-img rounded-top">
                                <img src="<?= base_url('assets/home/img/car-1.png');?>" class="img-fluid w-100 rounded-top" alt="">
                            </div>
                    ...
                    <div class="categories-item p-4">
                        <div class="categories-item-inner">
                            <div class="categories-img rounded-top">
                                <img src="<?= base_url('assets/home/img/car-2.png');?>" class="img-fluid w-100 rounded-top" alt="">
                            </div>
                            <div class="categories-content rounded-bottom p-4">
            ...
            <div class="container py-5">
                ...
                <div class="col-xl-12 wow fadeInUp">
                    <div class="bg-secondary p-5 rounded">
                        <h4 class="text-primary mb-4 text-center">Booking Sekarang</h4>
                        <form>
        ...
        <!-- Testimonial Start -->
        <div class="container-fluid testimonial pb-5" id="kataMereka">
            <div class="container pb-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
