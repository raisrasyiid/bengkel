...
<div id="content">
    ...
    <div class="container-fluid table-responsive">
        ...
        <div class="box-header">
            <h4 style="text-align:center"><b>Data User</b></h4>
            <hr>
        </div>
        <!-- DataTales Example -->
                        ...
                        <tbody>
                            <?php $no = 1; foreach($users as $val){?>
                                <tr>
                                    ...
                                    <td> <?php echo $val->no_hp_user; ?></td>
                                    <td> <?php echo $val->password_user; ?></td>
                                    <td class="project-actions text-center">
                                        <a class="btn btn-danger btn-sm" href="<?php echo site_url('user/delete/'.$val->id_user)?>" onclick="return confirm('Yakin Akan Hapus Data Ini?')">
